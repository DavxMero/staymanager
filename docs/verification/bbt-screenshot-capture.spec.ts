...
test('Capture: Halaman Login (Gambar 4.16)', async ({ page }) => {
  await page.goto(`${BASE_URL}/login`);
  await page.waitForLoadState('networkidle', { timeout: 15_000 }).catch(() => {});
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-16-bbt-login.png`, fullPage: false });
});
...
test('Capture: Modul Dashboard (Gambar 4.17)', async ({ page }) => {
  ...
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-17-bbt-dashboard.png`, fullPage: false });
});
...
test('Capture: Modul Manajemen Kamar (Gambar 4.18)', async ({ page }) => {
  ...
  await page.waitForLoadState('networkidle', { timeout: 15_000 }).catch(() => {});
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-18-bbt-rooms.png`, fullPage: false });
});
...
test('Capture: Modul Manajemen Tamu (Gambar 4.19)', async ({ page }) => {
  ...
  await page.waitForLoadState('networkidle', { timeout: 15_000 }).catch(() => {});
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-19-bbt-guests.png`, fullPage: false });
});
...
test('Capture: Modul Keuangan/Financial (Gambar 4.20)', async ({ page }) => {
  ...
  await page.waitForLoadState('networkidle', { timeout: 15_000 }).catch(() => {});
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-20-bbt-finance.png`, fullPage: false });
});
...
test('Capture: Modul Logistik/Inventaris (Gambar 4.21-alt)', async ({ page }) => {
  ...
  await page.waitForLoadState('networkidle', { timeout: 15_000 }).catch(() => {});
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-21-bbt-inventory.png`, fullPage: false });
});
...
test('Capture: Modul Chatbot (Gambar 4.22-alt)', async ({ page }) => {
  ...
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-22-bbt-chatbot.png`, fullPage: false });
});
...
test('Capture: Modul Laporan (Gambar 4.23-alt)', async ({ page }) => {
  ...
  await page.waitForLoadState('networkidle', { timeout: 15_000 }).catch(() => {});
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-23-bbt-reports.png`, fullPage: false });
});
...
test('Capture: Modul Pengaturan + RBAC (Gambar 4.24-alt)', async ({ page }) => {
  ...
  await page.waitForLoadState('networkidle', { timeout: 15_000 }).catch(() => {});
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${ASSET_DIR}/gambar-4-24-bbt-settings.png`, fullPage: false });
});
